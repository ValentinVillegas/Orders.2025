...
public partial class Register
{
    ...
    protected override void OnParametersSet()
    {
        ...
        titleLabel = "Registro de " + (isAdmin ? "Administrador" : "Usuario");
    }
    ...
    {
        SnackBar.Add("Llene todos los campos del formulario.", Severity.Warning);
    }
    ...
    private async Task CreateUserAsync()
    {
        ...
        if (isAdmin) userDTO.UserType = UserType.Admin;
